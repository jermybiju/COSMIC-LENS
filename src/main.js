...
apodCard.innerHTML = '<div class="loading"><div class="spinner"></div><p>fetching from NASA...</p></div>'
}
...
apodCard.innerHTML = mediaHTML + '<div class="apod-info"><p class="apod-date">' + formatDate(data.date) + '</p><h2 class="apod-title">' + data.title + '</h2><p class="apod-explanation">' + data.explanation + '</p>' + copyright + '</div>'
}
